...
```bash
python3 scripts/analyze_cwe.py --format markdown        # CWE weakness patterns
python3 scripts/analyze_tte.py --format markdown         # time-to-exploit + zero-days
python3 scripts/analyze_statistics.py --format markdown   # statistical framework
