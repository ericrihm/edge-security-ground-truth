...
| [Weaponization & Urgency](WEAPONIZATION.md) | Curated public-exploit availability (Exploit-DB/nuclei) and CISA emergency deadlines per CVE |
...
| [Metrics Roadmap](METRICS-ROADMAP.md) | Accurate signals to integrate next (exposure counts, weaponization, temporal EPSS), ranked by accuracy × tractability |
